...
import com.sftalert.utils.date.DecomposedDate;
import com.sftalert.utils.date.FechaDiaUtils;
import com.sftalert.utils.pojos.Tiempo;
...
// <editor-fold defaultstate="collapsed" desc="fechaHoraActual()"> 
    ...
    public static String hourFromDateToString(Date fecha, String... format) {
        ...
        try {
            ...
            MessagesUtil.error("hourFromDateToString() " + e.getLocalizedMessage());
        }
        return h;
...
// </editor-fold>
    ...
    public static Integer mesDeUnaFechaStartEneroWith1(Date date) {
        ...
        try {
            ...
            MessagesUtil.error( "getMesDeUnaFechaStartEneroWith1() " + e.getLocalizedMessage());
        }
        return 0;
...
// <editor-fold defaultstate="collapsed" desc="Integer minutosEntreFechas(Date fechaMayor, Date fechaMenor)"> 
    ...
    public static Boolean fechaMenor(Date date1, Date date2) {
        ...
        try {
            ...
            MessagesUtil.error( "fechaMenor() " + e.getLocalizedMessage());
        }
        return esmenor;
    }
    // </editor-fold>
    ...
    public static Boolean fechaMayor(Date date1, Date date2) {
        ...
        try {
            ...
            MessagesUtil.error( "fechaMayor() " + e.getLocalizedMessage());
        }
        return esmenor;
    }
    // </editor-fold>
    ...
    public static Boolean fechaIgual(Date date1, Date date2) {
        ...
        try {
            ...
            MessagesUtil.error( "fechaIgual() " + e.getLocalizedMessage());
        }
        return esmenor;
    }
    // </editor-fold>
...
// </editor-fold>
    ...
    public static Boolean isValidCierreMensual(Integer anioselected, String messelected, Integer diaminimo, ResourceBundle rs) {
        try {
            ...
            if (anioselected <= 0) {
                MessagesUtil.warning(rs.getString("warning.anionegativo"));
                return false;
            }
            if (anioselected > getAnioActual()) {
                MessagesUtil.warning(rs.getString("warning.anomayorqueactual"));
                return false;
            }

            Integer anio = getAnioActual() - anioselected;
            if (anio.intValue() > 1) {
                MessagesUtil.warning(rs.getString("warning.aniomuyantiguo"));
                return false;
            }
            if (anio.intValue() == 1 && !messelected.toLowerCase().equals("diciembre")) {
                MessagesUtil.warning(rs.getString("warning.debecerrardiciembredelañoanterior"));
                return false;
            }
            ...
            if (numeromesseleccionado > mesactual) {
                MessagesUtil.warning(rs.getString("warning.mesacerrarmayoractual"));
                return false;
            }
            if (numeromesseleccionado.equals(mesactual) && diaactual < diaminimo) {
                MessagesUtil.warning(rs.getString("warning.estacerrandoelmesmuypronto"));
                return false;
            }
            return true;
        } catch (Exception e) {
            MessagesUtil.warning("isValidCierreMensual" + e.getLocalizedMessage());
        }
        return false;
    }
...
//convertir la fecha de solicitud a LocalDate
    ...
    public static String showDate(Date date) {
        ...
        try {
            ...
            MessagesUtil.error("showDate() " + e.getLocalizedMessage());
        }
        return h;
    }// </editor-fold>
    ...
    public String showDateLocalDate(LocalDate date) {
        ...
        try {
            ...
            MessagesUtil.error("showDateLocalDate()" + e.getLocalizedMessage());
        }
    ...
    public static String showHour(Date date) {
        ...
        try {
            ...
            MessagesUtil.error("showHour() " + e.getLocalizedMessage());
        }
        return h;
    }// </editor-fold>
