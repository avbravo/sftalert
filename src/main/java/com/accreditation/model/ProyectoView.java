...
public class ProyectoView {
    ...
    public ProyectoView(Long idproyecto, String proyecto, String descripcion, String prefijo, Date fechafinal, Date fechainicial, Icono icono, Double avance, String estado, Boolean generarsprintautomaticamente, String periocidiadsprint, Integer diasDuracionSprint, Boolean colaboradorcreartarjeta, Boolean active, Boolean privado, Boolean showTarjetaPrivado, Boolean showTodasReserva, Boolean agregarTarjetaDuplicada, Integer diasAlertaVencimiento) {
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + Objects.hashCode(this.diasDuracionSprint);
    ...
    public String toString() {
        return "ProyectoView{" + "idproyecto=" + idproyecto + ", proyecto=" + proyecto + ", descripcion=" + descripcion + ", prefijo=" + prefijo + ", fechafinal=" + fechafinal + ", fechainicial=" + fechainicial + ", icono=" + icono + ", avance=" + avance + ", estado=" + estado + ", generarsprintautomaticamente=" + generarsprintautomaticamente + ", periocidiadsprint=" + periocidiadsprint + ", diasDuracionSprint=" + diasDuracionSprint + ", colaboradorcreartarjeta=" + colaboradorcreartarjeta + ", active=" + active + ", privado=" + privado + ", showTarjetaPrivado=" + showTarjetaPrivado + ", showTodasReserva=" + showTodasReserva + ", agregarTarjetaDuplicada=" + agregarTarjetaDuplicada + ", diasAlertaVencimiento=" + diasAlertaVencimiento + '}';
    }
