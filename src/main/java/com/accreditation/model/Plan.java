...
public class Plan {
    ...
    @Id(autogeneratedActive = AutogeneratedActive.OFF)
...
List<ActionHistory> actionHistory;
    ...
    public Plan(Long idsprint, String sprint, String descripcion, Date fechainicial, Date fechafinal, Boolean open, ProyectoView proyectoView, EstadisticaCierre estadisticaCierre, List<EstadisticaCierreColaborador> estadisticaCierreColaborador, List<ActionHistory> actionHistory, Boolean active) {
